...
import com.monster.Monster.Hunter.persistence.jwt.JwtUtil;
...
public class AuthService {
    ...
    public void registerUser(NewUserDto newUserDto){
        ...
        Role roleUser = roleRepository.findByNombre(RoleList.ROLE_USER).orElseThrow(()->new RuntimeException("Rol no encontrado"));
